      ...
      <div
        ...
        <div className='bg-white h-screen w-full flex flex-col items-center'>
          ...
          <div className='flex w-full items-center justify-center'>
            <h2 className='w-full inline-flex justify-center ml-10 mt-4'>주소 설정</h2>
      ...
      <div className='flex flex-col w-full justify-center items-center border rounded-b-xl bg-teal-300 pb-1'>
        <div className='flex justify-between w-full mt-5 p-2'>
          ...
          <div className='flex'>
            ...
            <button
              className='text-white hover:translate-y-1 hover:cursor-pointer hover:text-black/30 transition duration-300'
        ...
        <div className='flex w-full p-2'>
          <span className='flex w-1/7 pl-2 justify-center items-center inset-4 z-0 bg-white rounded-l-sm'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
              viewBox='0 0 24 24'
